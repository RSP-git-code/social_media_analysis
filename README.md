...
3. **Add the dataset**: Ensure that the `Social_media_usage.xlsx` file (containing the social media data) is placed in the same directory as the `social_media_usage.py` script or provide the path where you saved the excel file or you can even extract data using pd.read_html(url).
